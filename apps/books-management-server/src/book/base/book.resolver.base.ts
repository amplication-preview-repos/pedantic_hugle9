...
import { Publisher } from "../../publisher/base/Publisher";
...
export class BookResolverBase {
  ...
  @graphql.ResolveField(() => Publisher, {
    nullable: true,
    name: "publisher",
  })
  async getPublisher(
    ...
    const result = await this.service.getPublisher(parent.id);
